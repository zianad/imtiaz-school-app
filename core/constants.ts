...
import { Student, Teacher, Grade, Subject, EducationalStage } from './types';
...
export const MOCK_TEACHERS: Teacher[] = [
    {
        ...
        assignments: {
            ...
            'المستوى السادس ابتدائي': ['الفوج الأول', 'الفوج الثاني']
        }
    },
    {
        id: 'teacher2',
        ...
        assignments: {
            ...
            'الثالثة إعدادي': ['الفوج الأول', 'الفوج الثاني', 'الفوج الثالث']
        }
    },
    {
        id: 'teacher3',
