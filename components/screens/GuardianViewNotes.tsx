...
import { Note, Absence, Student, Subject, Grade } from '../../core/types';
...
const GuardianViewNotes: React.FC<GuardianViewNotesProps> = ({ notes, absences, student, title, onBack, onLogout }) => {
