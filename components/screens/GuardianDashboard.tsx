...
import { Student, Subject, Page, Notification, School, SchoolFeature, EducationalStage } from '../../core/types';
import LogoutButton from '../common/LogoutButton';
import NotificationIcon from '../common/NotificationIcon';
import LanguageSwitcher from '../common/LanguageSwitcher';
import { useTranslation } from '../../core/i18n';
import { STAGE_DETAILS, SUBJECT_ICONS } from '../../core/constants';
...
const GuardianDashboard: React.FC<GuardianDashboardProps> = ({ student, school, onSelectSubject, onLogout, navigateTo, notifications, toggleDarkMode, isDarkMode }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl border-t-8 border-blue-600 dark:border-blue-500 animate-fade-in text-center w-full relative">
            ...
            <div className="flex justify-between items-center mb-4">
                <div className="w-12"></div>
                 <div className="flex flex-col items-center">
                    {school.logoUrl && <img src={school.logoUrl} alt={`${school.name} Logo`} className="w-16 h-16 rounded-full object-contain mb-2 shadow-sm" />}
            ...
            <div className="text-center mb-6 p-4 bg-gray-100 dark:bg-gray-700/50 rounded-lg shadow-inner">
