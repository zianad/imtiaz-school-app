...
import { Page, School, SchoolFeature, EducationalStage } from '../../core/types';
import BackButton from '../common/BackButton';
import LogoutButton from '../common/LogoutButton';
import { useTranslation } from '../../core/i18n';
import LanguageSwitcher from '../common/LanguageSwitcher';
import { getStageForLevel } from '../../core/utils';
...
const TeacherActionMenu: React.FC<TeacherActionMenuProps> = ({ onSelectAction, onBack, onLogout, selectedLevel, school }) => {
    ...
    return (
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-xl border-t-8 border-blue-600 animate-fade-in w-full relative">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">اختر الإجراء المطلوب</h1>
