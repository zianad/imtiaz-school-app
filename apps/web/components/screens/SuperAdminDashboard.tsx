...
import { School, Page, Principal } from '../../../../packages/core/types';
                                ...
                                <button onClick={() => onManageSchool(school.id)} className="flex-grow text-right hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-md transition">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            {/* FIX: Explicitly type `p` as Principal to access loginCode property. */}
                                            <p className="text-xs text-gray-500 dark:text-gray-400">{t('principalCodeLabel')}: {Object.values(school.principals).flat().map((p: Principal) => p.loginCode).join(', ')}</p>
                                        </div>
                                    </div>
                                </button>
                                <button
